package vulnetix.rules.vnx_node_008

import rego.v1

metadata := {
	"id": "VNX-NODE-008",
	"name": "Node.js open redirect",
	"description": "Passing user input (req.query, req.params, req.body) directly to res.redirect() allows attackers to redirect users to malicious sites for phishing.",
	"help_uri": "https://docs.cli.vulnetix.com/docs/sast-rules/vnx-node-008/",
	"languages": ["node"],
	"severity": "medium",
	"level": "warning",
	"kind": "open",
