...
go install github.com/vulnetix/cli/v3@main

# Install from specific branch
go install github.com/vulnetix/cli/v3@feature/new-feature
```
...
GOOS=linux GOARCH=amd64 go install github.com/vulnetix/cli/v3@latest
GOOS=linux GOARCH=arm64 go install github.com/vulnetix/cli/v3@latest
GOOS=darwin GOARCH=amd64 go install github.com/vulnetix/cli/v3@latest
GOOS=darwin GOARCH=arm64 go install github.com/vulnetix/cli/v3@latest
GOOS=windows GOARCH=amd64 go install github.com/vulnetix/cli/v3@latest
...
go mod download github.com/vulnetix/cli/v3@latest
...
go install -gcflags="all=-N" github.com/vulnetix/cli/v3@latest
```
...
go install github.com/vulnetix/cli/v3@v3.59.4
mv $(go env GOPATH)/bin/vulnetix $(go env GOPATH)/bin/vulnetix-v3.59.4
...
GOARCH=amd64 go install github.com/vulnetix/cli/v3@latest  # Intel
GOARCH=arm64 go install github.com/vulnetix/cli/v3@latest  # Apple Silicon
```
...
go mod download -json github.com/vulnetix/cli/v3@latest | jq -r .Sum
