...
title: "Bamboo"
weight: 21
description: "Integrate Vulnetix CLI into Atlassian Bamboo build plans for automated vulnerability scanning."
---
...
Credentials come from A Bamboo variable marked as a password.
...
{{< callout type="info" >}}
Bamboo passes password variables to scripts as `bamboo_VARIABLE_NAME`, with the `bamboo_` prefix.
{{< /callout >}}
...
A shared artifact definition on the job.
...
To surface a breach without blocking the merge: Uncheck 'Fail the build on non-zero exit'.
