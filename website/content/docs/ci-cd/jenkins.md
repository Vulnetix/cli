...
title: "Jenkins"
weight: 6
description: "Integrate Vulnetix CLI into Jenkins declarative and scripted pipelines. Upload SARIF, CycloneDX, SPDX security reports for centralized vulnerability management."
---
...
{{< callout type="info" >}}
Use single quotes on `sh '...'`. With double quotes Groovy interpolates the credential *before* the shell runs, and it lands in the build log.
{{< /callout >}}
