...
weight: 25
description: "Integrate Vulnetix CLI into Forgejo Actions workflows for vulnerability scanning."
---
...
`.forgejo/workflows/vulnetix.yml`:
...
{{< callout type="info" >}}
As with Gitea, the GitHub composite action does not resolve here. Use the install script.
{{< /callout >}}
