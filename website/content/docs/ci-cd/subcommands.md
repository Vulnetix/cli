...
**Current as of writing** (Vulnetix CLI `v3.55.2`). Flags and default output paths change between releases. Check `vulnetix <command> --help`, and [open an issue](https://github.com/Vulnetix/cli/issues/new) if a page here is stale.
{{< /callout >}}
