...
title: "Buddy"
weight: 28
description: "Integrate Vulnetix CLI into Buddy pipelines for automated vulnerability scanning."
---
...
Credentials come from Buddy environment variables, marked as encrypted.
...
{{< callout type="info" >}}
Buddy exposes encrypted variables to the shell as-is; do not `echo` them.
{{< /callout >}}
...
The pipeline filesystem persists between actions in a run.
...
To surface a breach without blocking the merge: Uncheck 'Fail the pipeline on error' for the action.
