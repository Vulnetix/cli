...
|---|---|---:|---|---:|---|
| discovery document conforms to tea-well-known.schema.json | `wellKnownDiscoveryDocument` | 200 | yes | 640.42 ms | pass |
| discovery document is not served over plaintext HTTP | `wellKnownDiscoveryDocument` | 200 | - | 55.84 ms | pass |
