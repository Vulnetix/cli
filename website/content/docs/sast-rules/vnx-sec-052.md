---
title: "VNX-SEC-052 – Artifactory / JFrog API Key"
description: "Detects Artifactory and JFrog API keys (AKCp or cmVmd prefix) hardcoded in source code."
---
...
- gitleaks `artifactory-api-key`, `artifactory-reference-token`
