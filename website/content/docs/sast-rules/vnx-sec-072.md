---
title: "VNX-SEC-072 – Generic High-Entropy API Key / Secret"
description: "Detects high-entropy strings assigned to variables whose name contains a credential keyword (api_key, secret, token, password, etc.)."
---
