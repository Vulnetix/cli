---
title: "VNX-470 – Use of Externally-Controlled Input to Select Classes or Code ('Unsafe Reflection')"
description: "Detects Detects source patterns associated with CWE-470 (Use of Externally-Controlled Input to Select Classes or Code ('Unsafe Reflection')). Each finding should be manually reviewed for exploitability in context."
---

## Overview

VNX-470 maps to [CWE-470: Use of Externally-Controlled Input to Select Classes or Code ('Unsafe Reflection')](https://cwe.mitre.org/data/definitions/470.html). Detects source patterns associated with CWE-470 (Use of Externally-Controlled Input to Select Classes or Code ('Unsafe Reflection')). Each finding should be manually reviewed for exploitability in context.

**Severity:** High | **CWE:** [CWE-470](https://cwe.mitre.org/data/definitions/470.html) | **Languages:** java, python
