---
title: "VNX-440 – Expected Behavior Violation"
description: "Detects Detects source patterns associated with CWE-440 (Expected Behavior Violation). Each finding should be manually reviewed for exploitability in context."
---

## Overview

VNX-440 maps to [CWE-440: Expected Behavior Violation](https://cwe.mitre.org/data/definitions/440.html). Detects source patterns associated with CWE-440 (Expected Behavior Violation). Each finding should be manually reviewed for exploitability in context.

**Severity:** Low | **CWE:** [CWE-440](https://cwe.mitre.org/data/definitions/440.html) | **Languages:** python
